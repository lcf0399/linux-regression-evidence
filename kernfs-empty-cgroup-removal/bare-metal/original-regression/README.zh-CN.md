...
下文保留原来四项实验的 603 份样本。后来的 [INODE_INITED](../inode-inited/README.zh-CN.md)
与[独立 inode 请求标记](../inode-requested/README.zh-CN.md)放在并列目录，各自复核，不合池。
全部实验见[上级索引](../README.zh-CN.md)。
