...
Index updated on 2026-09-10. The MSG_RING v3 patch validation and lifecycle
follow-up were added on that date; the collaborator's v3 message was also checked.
The futex stable-queue status was checked live in Gmail
...
| [`io-uring-msg-ring-send-fd-install/`](io-uring-msg-ring-send-fd-install/) | Report sent on 2026-08-07 and publicly archived. Collaborator Uzair Beg supplied v3 on 2026-09-09; its validation is complete. The latest sent diagnostic reply remains 2026-09-03 UTC. This is not a maintainer resolution or merge confirmation. | Original exact slowdown remains `11.621%` at `7029acd8a950`. [Unchanged v3 on v6.18-rc4](io-uring-msg-ring-send-fd-install/bare-metal/uzair-v3-prefill/README.md) improves first fill by `9.791%` versus unpatched and same-ring 4,096-file remove/refill by `18.820%`. Registration through first fill does not improve; low-use/small-table instability and idle-memory cost remain explicit. |
