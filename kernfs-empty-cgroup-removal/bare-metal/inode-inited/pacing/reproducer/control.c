...
int main(int argc,char **argv)
{
	...
	if(!disabled||!pace||(strcmp(pace,"0")&&strcmp(pace,"50")&&strcmp(pace,"200")))return 2;
...
out:
	...
	printf("{\"schema\":\"cgroup-kernfs-inode-inited-pacing-v1\",\"scx_disabled\":%s,\"family\":%d,\"actor\":%d,\"n\":%d,\"same\":%d,\"callbacks\":%d,\"diagnostic\":%d,\"rounds\":%d,\"warmup\":%d,\"trace\":%s,\"root\":\"%s\",\"root_id\":%llu,\"a_id\":%llu,\"b_id\":%llu,\"restored\":true,\"exit_kind\":%d,\"tids\":[",
